  ...
  return (
    <>
      ...
      <div class="text-gray-700 bg-white">
        <nav class="fixed bg-white w-full z-10 border-b border-solid border-gray-300">
            ...
            <div class="hidden md:block">
              <ul class="inline-flex">
                <li>
                  <a
                    href="#"
                    class="px-4 text-2xl font-bold hover:text-gray-800"
                  >
                    Home
                  </a>
                </li>
        ...
        <nav>
          <div class="container mx-auto px-6 py-2 flex justify-between items-center">
            ...
            <div class="hidden md:block">
              <ul class="inline-flex">
                <li>
                  <a href="#" class="px-4 font-bold hover:text-gray-800">
                    Home
                  </a>
                </li>
                <li>
                  <a href="#" class="px-4 hover:text-gray-800">
                    About
                  </a>
                </li>
                <li>
        ...
        <div class="py-20 h-screen bg-green-700 flex w-full justify-center items-center">
          <div class=" px-6  w-full justify-center items-center">
            <div class="  text-white  ">
              <h5 className="text-[50px] mb-6">nhà của lạc</h5>

              <a className="text-2xl mb-8 text-gray-200">
                Chào mừng quý khách đến với website của quán cà phê chúng tôi!
                Chúng tôi rất hân hạnh được phục vụ quý khách với những ly cà
                phê thơm ngon, đậm đà và những món ăn ngon miệng. Hãy ghé thăm
                quán cà phê của chúng tôi để trải nghiệm không gian ấm cúng,
                thân thiện và dịch vụ chuyên nghiệp. Chúc quý khách có những
                giây phút thư giãn tuyệt vời tại quán cà phê của chúng tôi!
              </a>
            </div>
            <div class="text-2xl mb-8 text-gray-200 ">
              {/* A utility-first CSS framework for rapidly building custom designs. */}
              <a className="px-4 py-2 border rounded-md">
          ...
          <div class="flex items-center flex-wrap mb-10">
            <div class="w-full md:w-1/2 px-4">
              ...
              <p class="text-gray-600 mb-8">
                ...
                making it extremely easy to build responsive interfaces without
          ...
          <div class="flex items-center flex-wrap mb-20">
            ...
            <div class="w-full md:w-1/2 px-4">
              ...
              <p class="text-gray-600 mb-8">
                ...
                grows it can be useful to codify common patterns into higher
                level abstractions.
              </p>
            </div>
          </div>
          <div class="flex items-center flex-wrap mb-20">
            <div class="w-full md:w-1/2 px-4">
              ...
              <p class="text-gray-600 mb-8">
                ...
                customize it. This includes colors, border sizes, font weights,
                spacing utilities, breakpoints, shadows, and tons more.
              </p>
            </div>
            <div class="w-full md:w-1/2 px-4">
              <img
